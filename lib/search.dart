...
class _SearchScreenState extends State<SearchScreen> {
  ...
  List<Map<String, dynamic>> removeDuplicates(List<Map<String, dynamic>> list, String key) {
    ...
    for (var item in list) {
      if (uniqueKeys.add(item[key].toString())) {
        uniqueList.add(item);
      }
    }
  ...
  void initState() {
    super.initState();
    allMovies = removeDuplicates(allMovies, 'title');
  }
                                    ...
                                    builder: (context) => DetialsScreen(
                                        ...
                                        imageUrl:
                                            'https://image.tmdb.org/t/p/w500/' +
                                                allMovies[index]
                                                    ['backdrop_path'],
                                        overView: allMovies[index]['overview'],
                                        rate: allMovies[index]['vote_average']
                                            .toString(),
                                        date: allMovies[index]['release_date']),
                                  ));
                            },
                            child: Padding(
                                            ...
                                            imageUrl:
                                                'https://image.tmdb.org/t/p/w500/' +
                                                    filteredMovies[index]
                                                        ['backdrop_path'],
                                            overView: filteredMovies[index]
                                                ['overview'],
                                            rate: filteredMovies[index]
                                                    ['vote_average']
                                                .toString(),
                                            date: filteredMovies[index]
                                                ['release_date']),
                                      ));
                                },
                                child: Padding(
